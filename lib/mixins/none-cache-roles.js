(function() {
  'use strict';
  var Promise, RoleMixin, extend, hasPerm, isArray, isFunc, isObject, isString, loopback, removeArray, removeObject;
  ...
  RoleMixin = module.exports = function(Model, aOptions) {
    ...
    Model.prototype.getPerms = function(lastVisited) {
      ...
      if (isFunc(Model._getPerms)) {
        return Model._getPerms(this, this[rolesFieldName], lastVisited);
      } else {
    ...
    Model.prototype.hasPerm = function(aPermName, aContext) {
      return this.getPerms().then(function(aPerms) {
        return hasPerm(aPerms, aPermName, aContext, ownerFieldName);
      });
    };
...
//# sourceMappingURL=none-cache-roles.js.map
